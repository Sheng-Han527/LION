...
savefolder = pathlib.Path("/local/scratch/public/sh2146/Unet0.75")
...
#     plt.clim(0, 2.5)
#     plt.colorbar()
#     plt.savefig("fixed_modelt=0.75_reconstruction.png")
