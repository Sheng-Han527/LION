...
savefolder = pathlib.Path("/local/scratch/public/sh2146/Unet0.5/New")
...
#     plt.clim(0, 2.5)
#     plt.colorbar()
#     plt.savefig("fixed_modelt=0.5_reconstruction.png")
